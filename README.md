...
```text
Developer by skill · Product Thinker by passion · Building toward PM 🚀
```
...
> Currently a **Full-Stack Developer** with a strong eye for design and product thinking.   
> I bridge the gap between code and product — I speak both languages fluently.
